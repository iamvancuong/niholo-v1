...
use App\Filament\Resources\GrammarPoints\Pages\ViewGrammarPoint;
use App\Filament\Resources\GrammarPoints\Schemas\GrammarPointForm;
use App\Filament\Resources\GrammarPoints\Schemas\GrammarPointInfolist;
...
class GrammarPointResource extends Resource
{
    ...
    {
        return GrammarPointInfolist::configure($schema);
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => ViewGrammarPoint::route('/{record}'),
